...
// @description If the component doesn't exist then the component must go
// through repeated subtraction util a match from the S1 { M, D, C, L, X, V, I }
